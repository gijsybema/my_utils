...
print(f'Create folder to store nested cross-validation results - {outcome}')
...
# specify filename
file_name = f'02_nested_cv_results_{outcome}.txt'
...
print(f'Default cross-validation results for outcome {outcome} are stored under {destination_and_file}')     
